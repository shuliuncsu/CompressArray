...
/**
 * Compressed 2-D integer array (line compression version). This array cost same
 ...
 * @author Shu Liu
 */
public class CA2DInt implements Serializable {
     ...
     */
    public CA2DInt(int sizeX, int sizeY, int defaultValue) {
        if (sizeX <= 0 || sizeY <= 0) {
     ...
     */
    public void addRow(int beforeRow, int numRows, int defaultValue) {
        sizeX += numRows;
     ...
     */
    public void addColumn(int beforeColumn, int numColumns, int defaultValue) {
        sizeY += numColumns;
